    ...
    public class U : MonoBehaviour, IRocketImplementation, IModuleNexus
    {
        ...
        internal void Initialize()
        {
            try
            {
                ...
                {
                    try{
                        if (!System.IO.Directory.Exists(SDG.Framework.IO.IOUtility.rootPath + "/Bundles/Workshop")) 
                        {
                            System.IO.Directory.CreateDirectory(SDG.Framework.IO.IOUtility.rootPath + "/Bundles/Workshop");
                            System.IO.Directory.CreateDirectory(SDG.Framework.IO.IOUtility.rootPath + "/Bundles/Workshop/Content");
                            System.IO.Directory.CreateDirectory(SDG.Framework.IO.IOUtility.rootPath + "/Bundles/Workshop/Steam");
                            System.IO.Directory.CreateDirectory(SDG.Framework.IO.IOUtility.rootPath + "/Bundles/Workshop/Maps");
