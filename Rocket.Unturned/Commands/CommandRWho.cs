    ...
    class CommandRWho : IRocketCommand
    {
        ...
        public void Execute(IRocketPlayer caller, string[] command)
        {
            for (int i = 0; i < RCONServer.Clients.Count; i++)
            {
                ...
                UnturnedChat.Say(caller, U.Translate("command_rwho_line", i+1, client.InstanceID, client.Authenticated, client.Address, client.ConnectedTime.ToString(), connectedTimeFormat));
            }
        }
    }
}
